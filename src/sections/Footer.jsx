    ...
    <footer className='max-container'>
      <div className='flex justify-between items-start gap-20 flex-wrap max-lg:flex-col'>
        <div className='flex flex-col items-start'>
          <a href="/">
            <h1 className='text-4xl text-coral-red font-montserrat'>Kikee</h1>
          </a>
          <p className='mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-sm'>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. 
            Vitae totam perferendis quo eveniet sequi commodi!
          </p>
      ...
      <div className='flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center'>
        ...
        <p className="text-center text-coral-red"><span>Powered by: </span> <a className="cursor-pointer text-white" href="https://github.com/mavianDev/">Me.</a></p>
      </div>
    </footer>
  )
}
